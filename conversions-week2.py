...
print('Conversion 1: ' , number_of_miles ,'miles is equal to', \
      format (number_of_kilometers, ',.2f'),'kilometers!')

# b) get the information (input) for Fahrenheit to Celsius
# from the user and store it in a variable
number_of_fahrenheit = float(input('Please tell me how \
